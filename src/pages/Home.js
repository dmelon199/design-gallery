            ...
            <HomeHero />
              <div className="body-content">
                ...
                <div className="preowned-designs slideshow p-5">
                  ...
                  <div className="slide-design-footer d-flex justify-content-center">
                    <a className="btn-default px-3 py-2 mt-4 text-decoration-none" target="_blank" href=''>View All Preowned Designs</a>
                  </div>
                </div>
                <div className="splash-designs slideshow p-5">
                  ...
                  <div className="slide-design-footer d-flex justify-content-center">
                    <a className="btn-default px-3 py-2 mt-4 text-decoration-none" target="_blank" href=''>View All Splash Designs</a>
                  </div>
                </div>
              </div>
          </div>       
